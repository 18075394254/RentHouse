...
public class MyPublishRecyclerAdapter extends RecyclerView.Adapter<MyPublishRecyclerAdapter.ViewHolder>{
    ...
    private List<MyPublishAdapterInfo> mDatas;
    //定义一个接口
    ...
    public MyPublishRecyclerAdapter(@NonNull List<MyPublishAdapterInfo> mDatas) {
        this.mDatas = mDatas;
    }

    public List<MyPublishAdapterInfo> getmDatas() {
        return mDatas;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(View.inflate(parent.getContext(), R.layout.mypublish_recycler_item, null),mItemClickListener);
    }
