...
public class CollectionRecyclerAdapter extends RecyclerView.Adapter<CollectionRecyclerAdapter.ViewHolder>{
    ...
    private List<CollectionAdapterInfo> mDatas;
    //定义一个接口
    ...
    public CollectionRecyclerAdapter(@NonNull List<CollectionAdapterInfo> mDatas) {
        this.mDatas = mDatas;
    }

    public List<CollectionAdapterInfo> getmDatas() {
        return mDatas;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(View.inflate(parent.getContext(), R.layout.collection_recyclerview, null),mItemClickListener);
    }
