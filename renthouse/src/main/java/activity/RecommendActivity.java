...
public class RecommendActivity extends AppCompatActivity{
    String[] tab_titles_one = new String[]{"情侣抢先看","一人安心住","转租好房源"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MyApplication.setWindowStatusBarColor(RecommendActivity.this,R.color.tab_textColorSelect);

        setContentView(R.layout.activity_recommend);
        initOneTablayoutView();
        initTwoTablayoutView();
        initTwoRecyclerView();
        mBackImage = (ImageView) findViewById(R.id.recommend_iv_goback);
        mCardImage = (ImageView) findViewById(R.id.recommend_cardimageView);
        mRootView = (LinearLayout) findViewById(R.id.recommend_rootLin);
    ...
    private void initTwoRecyclerView() {
        ...
        mRecyclerView = (XRecyclerView) findViewById(R.id.recommend_RecyclerView);
        nestedSV = (MyNestedScrollView) findViewById(R.id.recommend_nestedSV);
        ...
        mLinearLayoutManager = new LinearLayoutManager(RecommendActivity.this, LinearLayoutManager.VERTICAL, false) {
            @Override
        ...
        mFiveAdapter.setListener(new RecyclerFiveAdapter.OnItemClickListener() {
            ...
            public void setOnitemClickListener(View view, int position) {
                //Toast.makeText(RecommendActivity.this,"位置 "+position+" 被点击了",Toast.LENGTH_SHORT).show();
    ...
    private void initTwoTablayoutView() {

        mTwoTabLayout = (TabLayout) findViewById(R.id.recommend_twotablayout);

        for (int i =0;i < tab_titles_two.length;i++){
            mTwoTabLayout.addTab(mTwoTabLayout.newTab().setText(tab_titles_two[i]));
        }
        //TabLayout的事件
        mTwoTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
    ...
    private void initOneTablayoutView() {

        mOneTabLayout = (TabLayout) findViewById(R.id.recommend_onetablayout);
