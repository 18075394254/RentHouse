...
public class CollectionRecordsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MyApplication.setWindowStatusBarColor(CollectionRecordsActivity.this,R.color.tab_textColorSelect);
        setContentView(R.layout.activity_browse_and_collection);
        titleText = findViewById(R.id.browse_and_collection_tv_title);
        titleText.setText("收藏记录");
        initRecyclerView();
    ...
    private void initRecyclerView() {
        ...
        mLinearLayoutManager = new LinearLayoutManager(CollectionRecordsActivity.this);
        ...
        mFiveAdapter.setListener(new RecyclerFiveAdapter.OnItemClickListener() {
            ...
            public void setOnitemClickListener(View view, int position) {
                ...
                startActivity(new Intent(CollectionRecordsActivity.this, DetailsActivity.class));
            }
        });
